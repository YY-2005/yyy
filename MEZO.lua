...
ControllerAll = false
local ListSudos ={Sudo_Id,5246153486,5049221213,1925760763}  
...
return {
Lock     = '[𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿](t.me/YY_VP)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه المسح *',
unLock   = '[𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿](t.me/YY_VP)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿](t.me/YY_VP)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الكتم *',
lockKid  = '[𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿](t.me/YY_VP)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه التقييد *',
lockKick = '[𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿](t.me/YY_VP)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الطرد *',
Reply    = '[𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿](t.me/YY_VP)\n*— — — — — — — — —\n◍ المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
data = {
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿', url = 't.me/YY_VP'}, 
},
}
}
...
local UserId_Info = LuaTele.searchPublicChat("E_S_L_T")
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ𝘼ٰٰ𝙃ِ𝙈ٌٓ𝙀ٰٰ𝘿ِِ 𝙎ٍَ𝙄ِ𝖱ٍ𝙄ٰ𝘼  ›', url = "https://t.me/E_S_L_T"}
},
}
local msgg = msg_id/2097152/0.5
...
if text == 'اسلام' or text == 'ديف' or text == 'المبرمج اسلام' then
photo = "https://t.me/ttrr_bt/2"
local T =[[
 [ᴘʀᴏɢʀᴀᴍᴍᴇʀ ESLAM 𖡼
...
keyboard.inline_keyboard = {
{
{text = '‹ DEV • ESLAM ›', url = "https://t.me/E_S_L_T"}
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿 𓁻', url = "https://t.me/YY_VP"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ٰDِٰAٰDِ Gٰٓaٓzٰaٌِl ', url = "https://t.me/E_S_L_T"}
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿', url = "https://t.me/YY_VP"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '𝗦َ??ٰ𝗨ِِ𝖱ٰ𝗖ٌ𝗘 𝗧ِٰٰ𝗛𝗢ِٰ𝖱', url = "https://t.me/YY_VP"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local T =[[
┌─────────────────────┐
├➤   [ٓWELCOME TO 𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿 𝆮 ☊](t.me/YY_VP)
├➤   [𝙩𝙝𝙚 𝙗𝙚𝙨𝙩 𝙨𝙤𝙪𝙧𝙘𝙚 𝙤𝙣 𝙚𝙜𝙮𝙥𝙩 ★](t.me/YY_VP)
├➤   [𝙧𝙪𝙣 𝙮𝙤𝙪𝙧 𝙗𝙤𝙩 W𝙞𝙩𝙝 𝙪𝙨 𝙣𝙤W ℘](t.me/YY_VP)
├➤   [ٰCH 𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿 ](t.me/YY_VP)
├─────────────────────┤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝙙ٍ𝙚َ𝙫 ₁', url = "https://t.me/E_S_L_T"},{text = '𝙙ٍ𝙚َ𝙫 ₂ •', url = "https://t.me/E_S_L_T"}
},
{
{text = '𝙙ٍ𝙚َ𝙫 ₃', url = "https://t.me/E_S_L_T"},{text = '𝙙ٍ𝙚َ𝙫 ₃', url = "https://t.me/E_S_L_T"}
},
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙃𝙊𝙍', url = "https://t.me/YY_VP"}
},
{
{text = '✵  • أضف البوت إلي مجموعتك • ✵ ', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿', url = 't.me/MEZO'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
...
data = {
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙃𝙊𝙍', url = 't.me/YY_VP'}, 
},
}
}
...
data = {
{
{text = '◍𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑨𝑻𝑹𝑰𝑿𖤣', url = 't.me/YY_VP'}, 
},
}
}
