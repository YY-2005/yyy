...
return {
Lock     = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_Max)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه المسح *',
unLock   = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_Max)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_Max)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الكتم *',
lockKid  = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_Max)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه التقييد *',
lockKick = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_Max)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الطرد *',
Reply    = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_Max)\n*— — — — — — — — —\n◍ المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
--download('https://raw.githubusercontent.com/TaG8H/Max/master/MAX.lua','MAX.lua')
...
local photo = LuaTele.getUserProfilePhotos(TheMAX)
local mrt = LuaTele.getUser(TheMAX)
for Name_User in string.gmatch(mrt.first_name, "[^%s]+" ) do
mrt.first_name = Name_User
break
end 
Groups = (Redis:scard(TheMAX..'MAX:ChekBotAdd') or 0)
Users = (Redis:scard(TheMAX..'MAX:Num:User:Pv') or 0)
if photo.total_count > 0 then
local MAXa = 'احصائيات الـــبوت'
...
{
{text = Grosupsw, url = 'https://t.me/G8_Max'}, 
},
{
{text = Usperos, url = 'https://t.me/G8_Max'}, 
},
}
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(MAXa).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
local TotalMsg = Redis:get(TheMAX..'MAX:Num:Message:User'..msg_chat_id..':'..Useriid_Info.id) or 0
local TotalEdit = Redis:get(TheMAX..'MAX:Num:Message:Edit'..msg_chat_id..Useriid_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*◍ ايديه : '..Useriid..
'\n◍ معرفه : '..UserInfousername..
...
data = {
{
{text = '‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›', url = 't.me/G8_Max'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevTheMAX,"md",true)  
else
...
{
{text = '‹ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›', url = "https://t.me/G8_Max"}
},
}
...
if Redis:get(TheMAX.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
local rep = msg.id/2097152/0.5
local m = rep +1
...
Redis:del(TheMAX.."youtube"..msg.sender.user_id..msg_chat_id)
end
if Redis:get(TheMAX.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = rep +1
https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg_chat_id.."&animation=https://t.me/youtube7odabot/7951&reply_to_message_id="..rep)
...
local CmdStart = '*\n🤖╖ أهلآ بك عزيزي أنا بوت'..(Redis:get(TheMAX.."MAX:Name:Bot") or "ماكس")..
...
return LuaTele.sendText(msg_chat_id,msg_id,'🐉︙ اهلا بك عزيزي المطور [تابع جديدنا♻️](https://t.me/G8_Max) ', 'md', false, false, false, false, reply_markup)
end
end
...
◍ ارسل ما تريد تحميله
*]]
Redis:set(TheMAX.."youtube"..IdUser..ChatId,'mp3')
...
◍ ارسل ما تريد تحميله
*]]
Redis:set(TheMAX.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
