...
io.write('\27[1;31m🏮︙تم حفظ آيدي آلمطور آلآسآسي  .\nDeveloper ID saved ⇧⇩\n\27[0;39;49m')
...
ControllerAll = false
local ListSudos ={Sudo_Id,1208165035,2059448162,1988823944,5246153486,01062069438}  
...
return{
JabwaAll = Redis:sismember(paris.."paris:JabwaAll:Groups",UserId) ,
ktmall = Redis:sismember(paris.."paris:ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(paris.."paris:JabwaGroup:Group"..ChatId,UserId) ,
...
local N = (Redis:get(paris.."paris:Name:Bot") or "ماتريكس")
...
--download('https://raw.githubusercontent.com/JABWA-paris/JEKA/master/paris.lua','paris.lua')
...
NamesBot = (Redis:get(paris.."paris:Name:Bot") or "ماتريكس")
...
{
{text = Jabwa, url = 't.me/YY_VP'}, 
},
{
{text = Grosupsw, url = 't.me/YY_VP'}, 
},
{
{text = Usperos, url = 't.me/YY_VP'}, 
},
}
...
Redis:sadd(paris.."paris:ChekBotAdd",msg_chat_id)
Redis:set(paris.."paris:Status:Id"..msg_chat_id,true) ;Redis:set(paris.."paris:Status:Reply"..msg_chat_id,true) ;Redis:set(paris.."paris:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(paris.."paris:Status:JabwaId"..msg_chat_id,true) ;Redis:set(paris.."paris:Status:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✯ اسم المجموعه -›〘*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*〙\n ✯ تم تفعيل المجموعه *','md', true, false, false, false, reply_markup)
end
end
...
local Info_Members = Redis:smembers(paris.."paris:JabwaAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(paris.."paris:JabwaGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(paris.."paris:Status:JabwaId"..msg_chat_id,true) 
...
Redis:del(paris.."paris:Status:JabwaId"..msg_chat_id) 
...
if Controller(msg_chat_id,UserId_Info.id) == 'هكر السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId_Info.id).." 〙*","md",true)  
end
...
Redis:sadd(paris.."paris:JabwaAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(paris.."paris:JabwaAll:Groups",UserId_Info.id) then
...
Redis:srem(paris.."paris:JabwaAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(paris.."paris:Status:JabwaId"..msg_chat_id) then
...
if Redis:sismember(paris.."paris:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✯ تم طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(paris.."paris:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'Jabwaned',0)
...
if not Redis:sismember(paris.."paris:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✯ تم الغاء طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(paris.."paris:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج ماديسون' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج ماديسون' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج ماتريكس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج اسلام' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'هكر السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
...
Redis:sadd(paris.."paris:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(paris.."paris:JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(paris.."paris:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(paris.."paris:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(paris.."paris:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'Jabwaned',0)
...
if not Redis:sismember(paris.."paris:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(paris.."paris:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,UserId) == 'المبرمج ماديسون' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج ماتريكس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج ماديسون' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
...
if Controller(msg_chat_id,UserId) == 'هكر السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
...
Redis:sadd(paris.."paris:JabwaAll:Groups",UserId) 
...
if Redis:sismember(paris.."paris:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(paris.."paris:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'Jabwaned',0)
...
if not Redis:sismember(paris.."paris:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(paris.."paris:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @YY_VP"..Creator.."\n"
else
...
if Redis:get(paris.."paris:Status:JabwaId"..msg.chat_id)  then
...
Redis:del(paris.."paris:JabwaAll:Groups") 
...
Redis:del(paris.."paris:JabwaGroup:Group"..msg_chat_id) 
...
local Name = '[⋆ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴍᴀᴛʀɪx ⋆](t.me/YY_VP)\n\n[⋆ ᴛʜᴇ ʙᴇѕᴛ ᴏɴ ѕᴏụʀᴄᴇ ᴛᴇʟᴇ ⋆](t.me/YY_VP)\n\n[⋆ ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʙᴇʟᴏᴡ ⋆](t.me/YY_VP)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '↝ ᴍʏ ᴅᴇᴠ .', url = "https://t.me/UU_MIX"},{text = '↝ sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx .', url = "https://t.me/YY_VP"},
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,' ✯ اليك قسم الالعاب من سورس ماتريكس ',"md",false, false, false, false, reply_markup)
end
...
local photo = LuaTele.getUserProfilePhotos(paris)
local Jabwa = LuaTele.getUser(paris)
...
local NamesBot = (Redis:get(paris.."paris:Name:Bot") or "ماتريكس")
local BotName = {
...
if text == (Redis:get(paris.."paris:Name:Bot") or "ماتريكس") then
local photo = LuaTele.getUserProfilePhotos(paris)
local Jabwa = LuaTele.getUser(paris)
local sudo_info = LuaTele.getUser(Sudo_Id)
local sudo_name = sudo_info.first_name
...
"تتوقع إنك بتتزوج اللي تحبه؟ ",
  ...
  "قد قابلت شخص تحبه؟ وولد ولا بنت؟ ",
   "هل انت تحب العزايزي؟",
      "هل انت تحب هكر السورس؟",
         "هل انت تحب المبرمج اسلام؟",
   "هل انت تحب صاصا؟",
   "هل انت تحب بلال؟ ",
...
local CmdStart = '*\n ✯ أهلآ بك في بوت '..(Redis:get(paris.."paris:Name:Bot") or "ماتريكس")..
...
if not msg.ControllerBot then
if Redis:get(paris.."paris:TwaslBot") and not Redis:sismember(paris.."paris:Jabwa:In:Tuasl",msg.sender.user_id) then
...
local TextHelp = [[*
℘︙قسم الالعاب الخاص بسورس ماتريكس  .
•━═━═━═『ᴍᴀᴛʀɪx』═━═━═━•
...
local TextHelp = [[*
℘︙اليك قسم الالعاب الخاص بسورس ماتريكس  .
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(paris.."paris:Status:JabwaId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(paris.."paris:Status:JabwaId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(paris.."paris:JabwaGroup:Group"..ChatId) 
