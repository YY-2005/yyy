...
ControllerAll = false
local ListSudos ={Sudo_Id,1414888743,1183747742,1554085475,1761050341,5076237918}  
...
Status = Redis:get(paris.."paris:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(paris.."paris:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(paris.."paris:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(paris.."paris:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(paris.."paris:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(paris.."paris:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(paris.."paris:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(paris.."paris:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(paris.."paris:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
local N = (Redis:get(paris.."paris:Name:Bot") or "باريس")
...
{
{text = '𓄼• sᴏᴜʀᴄᴇ ᴘᴀʀɪs •𓄹', url='https://t.me/belalelshayals'},
},
}
}
...
NamesBot = (Redis:get(paris.."paris:Name:Bot") or "باريس")
...
{
{text = Jabwa, url = 't.me/belalelshayals'}, 
},
{
{text = Grosupsw, url = 't.me/belalelshayals'}, 
},
{
{text = Usperos, url = 't.me/belalelshayals'}, 
},
}
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @belalelshayals"..Creator.."\n"
else
...
data = {
{
{text = '𓄼• sᴏᴜʀᴄᴇ ᴘᴀʀɪs •𓄹', url = 't.me/belalelshayals'}, 
},
}
}
...
local Name = '[⋆ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ paris ⋆](t.me/belalelshayals)\n\n[⋆ ᴛʜᴇ ʙᴇѕᴛ ᴏɴ ѕᴏụʀᴄᴇ ᴛᴇʟᴇ ⋆](t.me/belalelshayals)\n\n[⋆ ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʙᴇʟᴏᴡ ⋆](t.me/belalelshayals)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• ᴍʏ ᴅᴇᴠ •𓄹', url = "https://t.me/DEV_PARIS"},{text = '𓄼• ᴄʜᴀɴɴᴇʟ •𓄹', url = "https://t.me/belalelshayals"},
},
{
...
keyboard.inline_keyboard = {
{
{text = '𝐀𝐙𝐀𝐈𝐙𝐘‌ ➪🇫🇷', url = "https://t.me/php_7"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local CmdStart = '*\n ✯ أهلآ بك في بوت '..(Redis:get(paris.."paris:Name:Bot") or "باريس")..
...
data = {
{
{text = '𓄼•ᴍʏ ᴄʜᴀɴɴᴇʟ•𓄹', url = "https://t.me/belalelshayals"},
},
{
